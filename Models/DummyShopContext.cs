...
{
    public partial class DummyShopContext : DbContext
    {
        public DummyShopContext()
        {
        }

        public DummyShopContext(DbContextOptions<DummyShopContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-5A3V7O6;Initial Catalog=DummyShop;Persist Security Info=True;User ID=sa;Password=123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderTbl>(entity =>
            {
                ...
                entity.HasOne(d => d.CouponCodeNavigation)
                    ...
                    .HasConstraintName("FK_order_tbl_coupon_mstr");
